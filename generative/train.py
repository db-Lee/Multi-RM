...
from generative.utils import get_dataset
from generative.prompt_formats import CHAT_TEMPLATE
...
def main(configs):
    ...
    configs["completion_only_loss"] = True
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Training script for training generative reward models')
