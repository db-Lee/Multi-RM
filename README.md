...
- [test_smollm](https://huggingface.co/datasets/dongboklee/test_smollm): the multi-domain test dataset with CoTs (N=16) generated by [SmolLM3](hf.co/HuggingFaceTB/SmolLM3).
